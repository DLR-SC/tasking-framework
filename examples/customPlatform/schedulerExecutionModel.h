...
#ifndef TASKING_EXAMPLE_CUSTOM_SCHEDULEREXECUTIONMODEL_H_
#define TASKING_EXAMPLE_CUSTOM_SCHEDULEREXECUTIONMODEL_H_
...
public:
    ...
    /**
     * Forward the time, handle pending events and
     */
    void step(void);
...
#endif /* TASKING_EXAMPLE_CUSTOM_SCHEDULEREXECUTIONMODEL_H_ */
